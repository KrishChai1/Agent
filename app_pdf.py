...
def extract_pdf_fields(self, pdf_file, form_type: str) -> List[PDFField]:
        ...
        try:
            ...
            part_mapping = self.intelligent_part_detection_enhanced(
  ...
  def intelligent_part_detection_enhanced (self,all_field_data: List[Dict],form_type: str,form_structure: Dict[str, str], 
                                           page_text_content: Dict[int, str], has_attorney_section: bool) -> Dict[int, str]:
